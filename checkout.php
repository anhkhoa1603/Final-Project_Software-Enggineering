...
if(isset($_POST['order'])){
    ...
    $cart_products = array_filter($cart_products);
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="tel" name="number" placeholder="enter your number" autofocus required>
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="street" placeholder="e.g.  streen name" required>
            </div>
            <div class="inputBox">
                <span>city :</span>
