...
<section class="contact">
    ...
    <?php
        ...
        $row_user = $user_query->fetch_assoc();
    ...
    <form action="" method="POST">
        ...
        <input type="text" name="name" placeholder="enter your name" class="box" value= "<?php echo $user_name ?>"> 
        <input type="email" name="email" placeholder="enter your email" class="box" value= "<?php echo $user_email ?>">
